                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr class="row100 body" style="background-color: #96b4e1;" data-href='<?= base_url('admin/data_pasien/' . $ps['id']) ?>'>
                                        <?php } elseif ($ps['assesment']) { ?>
                                        <tr class="row100 body" style="background-color: #fce303;" data-href='<?= base_url('admin/data_pasien/' . $ps['id']) ?>'>
                                        <?php } else { ?>
